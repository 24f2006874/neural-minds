...
modelFile = '';
modelCandidates = {'drishti_dr_model.mat'};
for modelIndex = 1:numel(modelCandidates)
    if exist(modelCandidates{modelIndex}, 'file')
        modelFile = modelCandidates{modelIndex};
        break;
    end
end
